...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_newsType = (TextView)convertView.findViewById(R.id.tv_newsType);
	  ...
	  holder.tv_newsType.setText("新闻分类：" + mData.get(position).get("newsType").toString());
	  holder.tv_title.setText("新闻标题：" + mData.get(position).get("title").toString());
