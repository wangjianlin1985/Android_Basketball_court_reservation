			...
			public void onClick(View v) {
				try {
					...
					if(ET_leaveTitle.getText().toString().equals("")) {
						Toast.makeText(LeavewordAddActivity.this, "约战标题输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_leaveContent.getText().toString().equals("")) {
						Toast.makeText(LeavewordAddActivity.this, "约战内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(LeavewordAddActivity.this, "约战电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_leaveTime.getText().toString().equals("")) {
						Toast.makeText(LeavewordAddActivity.this, "约战时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传约战留言信息*/
					LeavewordAddActivity.this.setTitle("正在上传约战留言信息，稍等...");
