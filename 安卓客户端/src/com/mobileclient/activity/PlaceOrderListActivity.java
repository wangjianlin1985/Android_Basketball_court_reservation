...
public class PlaceOrderListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(PlaceOrderListActivity.this, PlaceOrderQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(PlaceOrderListActivity.this, PlaceOrderAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new PlaceOrderSimpleAdapter(PlaceOrderListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(PlaceOrderListActivity.this, PlaceOrderDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑场地预订信息
			...
			Intent intent = new Intent();
			intent.setClass(PlaceOrderListActivity.this, PlaceOrderEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("orderId", orderId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(PlaceOrderListActivity.this);
