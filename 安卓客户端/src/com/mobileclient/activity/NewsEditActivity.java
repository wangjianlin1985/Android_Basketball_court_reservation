...
public class NewsEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_newsType.getText().toString().equals("")) {
						Toast.makeText(NewsEditActivity.this, "新闻分类输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传篮球新闻信息*/
					NewsEditActivity.this.setTitle("正在更新篮球新闻信息，稍等...");
	...
	private void initViewData() {
		...
		this.ET_newsType.setText(news.getNewsType());
		...
		this.ET_publishTime.setText(news.getPublishTime());
	}
	@Override
