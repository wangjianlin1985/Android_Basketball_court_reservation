	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_placePhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(PlaceAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_placeName.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "场地名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(place.getPlacePhoto() != null) {
						...
						PlaceAddActivity.this.setTitle("正在上传图片，稍等...");
						String placePhoto = HttpUtil.uploadFile(place.getPlacePhoto());
						PlaceAddActivity.this.setTitle("图片上传完毕！");
						place.setPlacePhoto(placePhoto);
					} else {
						place.setPlacePhoto("upload/noimage.jpg");
					}
					/*验证获取球场地址*/ 
					if(ET_placePos.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "球场地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_placePrice.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "球场价格输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_placeDesc.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "球场介绍输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_onlineTime.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "营业时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_topFlag.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "是否置顶输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(PlaceAddActivity.this, "发布时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传篮球场地信息*/
					PlaceAddActivity.this.setTitle("正在上传篮球场地信息，稍等...");
					String result = placeService.AddPlace(place);
