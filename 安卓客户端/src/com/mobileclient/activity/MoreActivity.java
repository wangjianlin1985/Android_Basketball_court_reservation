...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"场地预订记录管理","视频类型管理","时段信息管理","篮球新闻管理","约战留言管理","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(declare.getIdentify().equals("user")) {
			strs = new String[]{"我的预订记录","约战留言","修改个人信息","关于"};
		}
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(declare.getIdentify().equals("admin")) {
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, PlaceOrderListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
						
						Intent intent  = new Intent(MoreActivity.this, VideoTypeListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 2){
						Intent intent  = new Intent(MoreActivity.this, TimeSectionListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 3){
					...
					if(arg2 == 4){
						Intent intent  = new Intent(MoreActivity.this, LeavewordListActivity.class);
						startActivity(intent);
					}
					...
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, PlaceOrderUserListActivity.class);
						startActivity(intent);
					}
