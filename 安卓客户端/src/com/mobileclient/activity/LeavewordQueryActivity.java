	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*获取查询参数*/
					queryConditionLeaveword.setLeaveTitle(ET_leaveTitle.getText().toString());
					queryConditionLeaveword.setTelephone(ET_telephone.getText().toString());
					queryConditionLeaveword.setLeaveTime(ET_leaveTime.getText().toString());
